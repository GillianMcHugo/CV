# My [**CV**](https://github.com/gillianmchugo/CV/GillianMcHugo_CV.pdf) made using the [**`vitae`**](https://github.com/mitchelloharawild/vitae) package with [**R Markdown**](https://rmarkdown.rstudio.com/).
