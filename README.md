# My [**CV**](https://github.com/gillianmchugo/CV/blob/master/GillianMcHugo_CV.pdf) made using the [**`vitae`**](https://github.com/mitchelloharawild/vitae) package with [**R Markdown**](https://rmarkdown.rstudio.com/).
